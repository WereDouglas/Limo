...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Roles User'), ['action' => 'edit', $rolesUser->users_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Roles User'), ['action' => 'delete', $rolesUser->users_id], ['confirm' => __('Are you sure you want to delete # {0}?', $rolesUser->users_id)]) ?> </li>
