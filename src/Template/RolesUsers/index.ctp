    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $rolesUser->users_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $rolesUser->users_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rolesUser->users_id], ['confirm' => __('Are you sure you want to delete # {0}?', $rolesUser->users_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
