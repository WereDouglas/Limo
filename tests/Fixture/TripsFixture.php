...
class TripsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'drop_off_address' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        're_route' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'fk_trips_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_trips_companies1_idx' => ['type' => 'index', 'columns' => ['company_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'company_id', 'drop_off_address'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'drop_off_address' => '641bf67c-738c-4884-994f-add9cf665119',
                ...
                're_route' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
